    ...
    */
    initLocators() {
        return {
            ...
            sqCCNumber: iframe => this.locators.sqIframeCreditCard(iframe).locator('#cc_number'),
            sqCCExp: iframe => this.locators.sqIframeCreditCard(iframe).locator('#cc_exp'),
            sqCCCsc: iframe => this.locators.sqIframeCreditCard(iframe).locator('#cc_csc'),
